...
include '../database/loginsystem_database/_dbsignup.php';
?>
...
<body>
  ...
  <div class="login-bg">
    ...
    <h2 class="text-center" style="margin-top:9vh">Register</h2>
    <div class="container shadow-lg rounded mb-5 p-3" style="width:520px; background:gray; opacity:0.8">
      <div class="container px-4" style="width:520px">
        ...
        <form action="../loginsystem/signup.php" method="post">
          ...
          <div class="form-group px-4">
            ...
            <input type="password" maxlength="18" class="form-control" id="cpassword" name="cpassword">
            <div class="form-text text-light">Make sure to type the same password</div>
          </div>
          </strong>
          <button type="submit" class="btn btn-primary mx-5 my-3">Register</button>
        </form>
      </div>
    </div>
  </div>

  <!-------------x--------------- signup page container --------x--------------->
